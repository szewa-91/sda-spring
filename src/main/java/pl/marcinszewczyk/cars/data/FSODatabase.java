...
public class FSODatabase {
    ...
    public FSODatabase() {
        carInformation.put("Caro", new Car("Polonez Caro", CarSegment.C, "5-drzwiowy hatchback", 1967, "1.4 l", 86));
        carInformation.put("125p", new Car("Fiat 125p", CarSegment.D, "Samochód osobowy klasy średniej", 1976, "1.5 l", 60));
        carInformation.put("126", new Car("Fiat 126", CarSegment.A, "Małe autko", 1973, "0.6 l", 23));
    }
